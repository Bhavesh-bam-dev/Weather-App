...
const OneDayData = ({ data, format }: OneDayDataProps) => {
	return (
		<div className="flex flex-col rounded-[8px] bg-card p-4 mb-4">
			...
			<div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 mt-3 text-text-on-accent">
				{data.map((item) => {
					...
					return (
						<div key={item.time} className="flex flex-col bg-accent items-center justify-center rounded-[8px] p-4">
							<p>{time}</p>
